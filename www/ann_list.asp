                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading panel-table">
                                <table id="tbl-head" class="table table-hover table-condensed table-responsive">
                                    <tr>
                                        <th class="col-sm-4 col-md-2">
                                            <a href="<%=strURL%>?sortOrder=1&action=<%=action%>">Title</a>
                                        </th>
                                        <th class="col-sm-4 col-md-4">
                                            <a href="<%=strURL%>?sortOrder=2&action=<%=action%>">Description</a>
                                        </th>
                                        <th class="col-sm-1 col-md-1">
                                            <a href="<%=strURL%>?sortOrder=3&action=<%=action%>">Type</a>
                                        </th>
                                        <th class="col-sm-1 col-md-2">
                                            <a href="<%=strURL%>?sortOrder=4&action=<%=action%>">Start Date <wbr />&amp; Time</a>
                                        </th>
                                        <th class="col-sm-1 col-md-2">
                                            <a href="<%=strURL%>?sortOrder=5&action=<%=action%>">Finish Date <wbr />&amp; Time</a>
                                        </th>
                        ...
                        <div class="panel <%=elcls%>">
                            ...
                            <div style="padding:0px;" class="panel-body panel-<%=trCls%>">
                                <div id="<%=elhref%>" style="padding:0px 20px 0px 20px;" class="panel-collapse collapse col-sm-12 col-md-12 bg-<%=trCls%>">
                                    <div style="margin-top:20px" class="info-item col-sm-12 col-md-12 <%=trCls%>">
                                        <span>Description:&nbsp;</span><%=htmlEntityEncode(objRs("Description"))%>
                                    </div>
                                    <div class="info-item col-sm-12 col-md-12 <%=trCls%>">
                                        <%x=objRs("Image")%>
                                        <%if isempty(x) or isnull(x) or trim(x)="" then x="None"%>
                                        <span style="padding-left:0px;" class="col-sm-6 col-md-6">Image: <%=htmlEntityEncode(x)%></span>
